...
<main id="primary" class="site-main resources-with-sidebar">
<?php
if ( have_rows('home_page_section') ):
  while ( have_rows('home_page_section') ) : the_row();
    ...
    elseif ( get_row_layout() == 'bubbles_section_copy' ):
    ...
    elseif ( get_row_layout() == 'scrolling_sidebar' ):
      get_template_part('template-parts/section', 'scrolling-sidebar');
